...
compile_time_timeout_seconds = 3600
######################################
...
#                 operation_stats = {
#                 "add": [], "sub": [], "multiply_plain": [], "rotate_rows": [], "poly_modulus": [],
...
#                     benchmark_run_command = f"./{subfolder_name} {vectorize_code} {window_size} 1 {cse_enabled} {slot_count}"
#                     try: 
#                         result = subprocess.run(
            ...
            try : 
                ...
                for iteration in range(iterations):
                    ...
                    if os.path.isdir(build_path):
                        ...
                        command = f"./{subfolder_name} {tree_depth} {iteration+1} {regime} {vectorize_code} "
