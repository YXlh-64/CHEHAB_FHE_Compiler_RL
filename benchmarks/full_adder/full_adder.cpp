...
void fhe(int width)
{ 
  Ciphertext c000("c000");
  Ciphertext c001("c001");
  Ciphertext c010("c010");
  Ciphertext c100("c100");
  Ciphertext c011("c011");
  Ciphertext c101("c101");
  Ciphertext c110("c110");
  Ciphertext c111("c111");
  Ciphertext s00("s00");
  Ciphertext s01("s01");
  Ciphertext s10("s10");
  Ciphertext s11("s11");  
  Ciphertext output ;
  output = cond(c000, s00,
                cond(c001, s10,
                cond(c010, s10,
                cond(c100, s10,
                cond(c011, s01,
